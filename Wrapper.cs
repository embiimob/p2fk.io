...
namespace P2FK.IO
{
    public class Wrapper
    {
        ...
        private static Task<string> QueueCliExecution(Func<Task<string>> operation, CancellationToken cancellationToken) =>
            _cliTaskFactory.StartNew(operation, cancellationToken).Unwrap();
